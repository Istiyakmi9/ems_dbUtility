...
import io.github.Istiyakmi9.utils.DatabaseConfiguration;
import io.github.Istiyakmi9.utils.TemplateJDBC;
import io.github.Istiyakmi9.utils.TypeConverter;
...
public class DatabaseManager {
    @Autowired
    DatabaseUtilis dbUtils;
    @Autowired
    ObjectMapper mapper;
    private JdbcTemplate jdbcTemplate;

    @Autowired
    DatabaseManager(DatabaseConfiguration databaseConfiguration) {
